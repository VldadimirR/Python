    ...
    while True:
        try:
            ...
            while int(ent_menu) not in range(1, quan):
                ...
                log.universal_logger("Неверный пункт меню",
                                     data_description="Ошибка ввода")
                ent_menu = (input())
            return int(ent_menu)
        except ValueError:
            print('\nНеверный формат! Повторите ввод:')
            log.universal_logger("Неверный формат ввода меню",
                                 data_description="Ошибка ввода")
...
def check_int():
    while True:
        try:
            ...
            print('\nНеверный формат! Повторите ввод:')
            log.universal_logger("Неверный формат ввода данных",
                                 data_description="Ошибка ввода")
